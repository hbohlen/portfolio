...
const Projects = (props: Props) => {
  ...
  return (
    <motion.div
      ...
      className="h-screen relative flex overflow-hidden flex-col text-left md:flex-rowmax-w-full justify-evenly mx-auto items-center z-0">
